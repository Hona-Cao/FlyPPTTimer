...
[下载与安装](#download) · [v1.15.0 新功能](#v1150) · [v1.14.1 新用法](#v1141) · [快速开始](#quick-start) · [七个设置模块](#settings) · [手机遥控](#phone) · [常见问题](#faq) · [完整教程](docs/USER_GUIDE.zh-CN.md)

<a id="download"></a>
## 下载与安装

以下下载均为 **v1.15.0**。本版便携版与安装版由同一份已通过验证的 v1.15.0 可执行文件打包；包内 README、完整教程与当前图文说明均对应 v1.15.0。
