...
subject to their own licenses; the FlyPPTTimer Freeware License does not replace
them.
...
versions. See `LICENSE` for the transition notice governing later official
releases.
