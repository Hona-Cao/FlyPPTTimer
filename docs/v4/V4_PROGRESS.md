...
- 当前阶段：**阶段 6 完成 — 全功能候选版（完整文档与候选 Artifact 已由 CI 产出；不创建正式 Release/Tag）**
- 阶段 0 完成度：**100%**
- 阶段 1 完成度：**100%**
- 阶段 2 完成度：**100%**
- 阶段 3 完成度：**100%**
- 阶段 4 完成度：**100%**（CI 31166500912 成功）
- 阶段 5 完成度：**100%**（CI 31168074938 成功，提交 `ac6a31e`）
- 阶段 6 完成度：**100%**（候选 Artifact = CI 31168074938；文档与人工验收计划齐备）
- 全工程完成度：**约 73%**（矩阵 72/99 完成；阶段 0–6 候选版达成；剩余“兼容保留”行为待后续收敛）
...
| 5 唯一入口/更新/安装/发布 | 完成 | 删除无兼容责任旧 UI、移除经典设置回退、双 EXE 发布链、V4 用户指南 + 人工测试计划 | 提交 `ac6a31e`；CI 31168074938 成功 |
| 6 全功能候选版 | 完成 | 完整文档与候选 Artifact（CI 双 EXE Artifact） | 候选 Artifact = CI 31168074938；不创建正式 Release/Tag |
...
- V4 用户指南（zh-CN/en）与人工测试计划文档已补齐；阶段 6 候选 Artifact 由 CI 31168074938 产出（双 EXE + SHA-256），不创建正式 Release/Tag。

阶段 5 已完成并经 CI 验收：提交 `ac6a31e`（CI 31168074938 成功）移除经典设置回退、删除无兼容责任的旧 WinForms UI（11 个源文件）与对应旧测试（23 个文件），补齐 V4 用户指南与人工测试计划，主程序/Core/WPF Settings 三个 Release Build 0/0，桌面 184 + Core 4 测试全过，双 EXE 发布 + Chromium 远程 + 三组发布版 WPF UIA 全绿。阶段 6 候选版达成：完整文档与候选 Artifact 齐备，PR #2 保持 Draft，不触碰 `main`，不创建 Release/Tag。剩余少量“兼容保留”行为（静音/结束放映/更新检查）的收敛列为后续迭代。
