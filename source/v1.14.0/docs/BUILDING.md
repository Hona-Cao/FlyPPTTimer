# Building and packaging FlyPPTTimer v1.14.0
...
The script uses `docs/v1140-default-config.json` for clean current defaults, includes app-local VC runtime DLLs, license and current documentation, compiles the per-user installer, and emits:

- `artifacts/release/v1.14.0/FlyPPTTimer-v1.14.0-portable-win-x64.zip`
- `artifacts/release/v1.14.0/FlyPPTTimer-v1.14.0-setup-win-x64.zip`
...
For the first public v1.14.0 release, packaging deliberately reuses the exact application accepted by the user, from Actions run `34709344878`, product source `e625c809f8cf7515f0143fab476bb4467d2fe1d7`:
...
[Real development timeline](DEVELOPMENT_HISTORY.md) · [Screenshot reproduction](media/v1.14.0/README.md)
